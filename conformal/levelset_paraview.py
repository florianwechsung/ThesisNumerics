...
for i in range(6):
    ...
    label = directory[0:-1].replace(".", "p")

    img_directory = "./output/levelset/" + "img/"
    if not os.path.exists(img_directory):
        os.makedirs(img_directory)
    # create a new 'PVD Reader'
    dilatation_pvd = PVDReader(FileName="./output/levelset/" + directory + filename)
    # get animation scene
    ...
    renderView1.ViewSize = [int(500*(7.5/4.5)), 500]

    renderView1.InteractionMode = '2D'
    renderView1.CameraPosition = [-0.0, 0.73, 1]
    renderView1.CameraFocalPoint = [-0.0, 0.73, 0]
    renderView1.CameraParallelScale = 1.09
    ...
    meshQuality1.TriangleQualityMeasure = 'Radius Ratio'
